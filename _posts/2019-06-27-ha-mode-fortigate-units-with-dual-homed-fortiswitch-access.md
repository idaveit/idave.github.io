...
{% highlight plaintext linenos hl_lines=5 %}
config switch trunk
...
{% endhighlight %}
{:style="list-style-type: none;"} 100. The only command you should add is line 5, the rest should be pre-filled in by the Fortilink autoconfiguration process.
{:start="4"}
