...
3. From the CLI of the Fortigate, do exec ssh admin@<FSW-IP> to log in directly to the first Fortiswitch, then add <pre>set mclag-icl enable</pre> under the trunk configuration.
    ```
config switch trunk
