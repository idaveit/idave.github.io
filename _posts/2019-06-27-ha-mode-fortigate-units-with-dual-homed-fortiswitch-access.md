...
3. From the CLI of the Fortigate, do exec ssh admin@<FSW-IP> to log in to the first Fortiswitch. The bit in red is the only command you should add, the rest should be pre-filled in by the Fortilink autoconfiguration process. {% highlight plaintext linenos %}
config switch trunk
