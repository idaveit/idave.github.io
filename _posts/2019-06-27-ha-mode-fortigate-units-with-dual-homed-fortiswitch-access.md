...
3. From the CLI of the Fortigate, do exec ssh admin@<FSW-IP> to log in directly to the first Fortiswitch, then add "set mclag-icl enable" under the trunk configuration.
    ```
config switch trunk
